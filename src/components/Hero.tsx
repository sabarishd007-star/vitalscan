...
function Hero() {
  return <section className="relative overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 py-20 text-center">
      ...
      <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-6">Your Personal <span className="bg-clip-text text-transparent" style={{ backgroundImage: "linear-gradient(135deg, #ec4899, #8b5cf6, #06b6d4)" }}>SkinCare</span><br />Assistant</h1>
